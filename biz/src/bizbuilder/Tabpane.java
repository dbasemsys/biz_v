...
public class Tabpane extends JTabbedPane {
    ...
    public class TabpaneUI extends MetalTabbedPaneUI {
                ...
                public void stateChanged(ChangeEvent ce) {
                    ...
                    if (selected != -1) {
                        if (currentRectangle != null) {
                            ...
                            target = new PropertySetter(TabpaneUI.this, "currentRectangle", currentRectangle, getTabBounds(selected, calcRect));
